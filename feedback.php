<?php 
    ...
    // Note: using $conn instead of $con
    $query = mysqli_query($conn, "INSERT INTO feedback(year, sem, date, branch, section, subject, ques1, ques2i, ques2ii, ques2iii, ques2iv, ques2v, ques3, ques4, remarks) 
